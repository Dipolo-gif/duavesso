...
export const PRODUCTS=[
 ...
 {id:'geek-coracao',name:'Coração Pixelado',brand:'geek',category:'geek',color:'Preta',base:'black',swatch:'#26272a',photos:['geek-coracao-1','geek-coracao-2','geek-coracao-3'],price:15990,tag:'DUAVESSOGEEK',graphic:'',graphicClass:'',description:'Coração anatômico em pixel art que se desmancha em blocos, com PLAYER 01 no peito. Oversized preta em suedine 250 g.',print:'Serigrafia à base d’água, toque leve, resistente a lavagens',...HEAVY_SPEC},
 {id:'geek-carpa',name:'Carpa Japonesa',brand:'geek',category:'geek',color:'Off white',base:'white',swatch:'#efece3',photos:['geek-carpa-1','geek-carpa-2','geek-carpa-3'],price:15990,tag:'DUAVESSOGEEK',graphic:'',graphicClass:'',description:'Carpa koi em nanquim com o sol laranja, entre a arte japonesa e o traço geek. Oversized off white em suedine 250 g.',print:'Serigrafia à base d’água, toque leve, resistente a lavagens',...HEAVY_SPEC}
]
...
export function shippingSuggestion(items){
 ...
 const inCart=new Set(items.map(i=>i.id)),candidates=[...PRODUCTS].filter(p=>!p.brand).sort((a,b)=>a.price-b.price);
